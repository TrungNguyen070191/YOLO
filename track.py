...
def detect(opt, save_img=False):
    ...
    for frame_idx, (path, img, im0s, vid_cap) in enumerate(dataset):
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if det is not None and len(det):
                ...
                if save_txt and len(outputs) != 0:
                    for j, output in enumerate(outputs):
                        ...
                        array_detected_object = list(dict.fromkeys(array_detected_object))
                        ...
                        if identity not in detectedIds and int(bbox_top) >= 10:
                            ...
                            if int(bbox_top) >= 500 or (int(bbox_left) >= 800 and int(bbox_top) >= 80) :
                                peopleOut += 1
                            if int(bbox_top) <= 100:
                                peopleIn +=1
            ...
            cv2.putText(im0, "People in out counted: " + str(peopleIn + peopleOut), (50, 100), font, 0.8, (0,255,255),2,font)
            cv2.putText(im0, "Number people in: " + str(peopleIn), (50, 135), font, 0.8, (0,255,255),2,font)
            cv2.putText(im0, "Number people out: " + str(peopleOut), (50, 170), font, 0.8, (0,255,255),2,font)
            ...
            if view_img:
                ...
                if cv2.waitKey(1) == ord('q'):  # q to quit
                    ...
                    print("Number people out: " + str(peopleOut))
                    with open(txt_path, 'a') as f:
                        f.write("All people counted: " + str(peopleIn + peopleOut))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='rtsp://admin:A123abcd%40%23@123.21.216.20:554/cam/realmonitor?channel=1&subtype=0', help='source')  # file/folder, 0 for webcam
